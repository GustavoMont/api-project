...
namespace api_project.Migrations
{
    public partial class UpdatigModels : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
                ...
                .CreateTable(
                    ...
                    columns: table =>
                        new
                        {
                            ...
                            Type = table
                                .Column<string>(type: "varchar(10)", nullable: false)
                ...
                .CreateTable(
                    ...
                    columns: table =>
                        new
                        {
                            ...
                            CompletionDeadline = table.Column<DateTime>(
                                type: "datetime",
                                nullable: false
                            ),
                            ContractId = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder
                .CreateTable(
                    ...
                    {
                        table.PrimaryKey(
                            "PK_ProfessionalService",
                            x => new { x.ProfessionalsId, x.ServicesId }
                        );
                        table.ForeignKey(
        ...
        {
            migrationBuilder.DropTable(name: "ClientContacts");

            migrationBuilder.DropTable(name: "Contracts");

            migrationBuilder.DropTable(name: "ProfessionalContact");

            migrationBuilder.DropTable(name: "ProfessionalService");
